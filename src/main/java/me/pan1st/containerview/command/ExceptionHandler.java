package me.pan1st.containerview.command;
...
final class ExceptionHandler {
    ...
    ExceptionHandler(final ContainerView plugin, final CommandManager<CommandSender> commandManager) {
        this.plugin = plugin;
    ...
    private static Component noPermission(final Exception e) {
        return Common.deserialize(ContainerView.getInstance().setting.noPermission);
    }
